...
export default function NotaPembayaranPentadbiranReportPage() {
  ...
  return (
    <div className="container py-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2 no-print">
        <h4 className="mb-0">Laporan Nota Butiran Pembayaran Pentadbiran</h4>
      ...
      {data && (
        <div ref={printRef} className="print-area">
          ...
          {/* Main Header */}
          <p className="fw-bold mb-3">11. Pentadbiran</p>
          ...
          {/* Summary Table (f. Pentadbiran) */}
          <div className="mb-4">
            <p className="fw-bold mb-2 ms-3">f. Pentadbiran</p>
            <table className="table table-bordered" style={{ fontSize: '13px' }}>
              <thead>
                <tr className="table-light">
                  <th style={{ width: '40px' }} className="text-center">Bil</th>
