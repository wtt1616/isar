...
export default function NotaPenerimaanDepositReportPage() {
  ...
  return (
    <div className="container py-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2 no-print">
        <h4 className="mb-0">Laporan Nota Butiran Penerimaan Deposit Diterima/Wang Cagaran</h4>
      ...
      {data && (
        <div ref={printRef} className="print-area">
          ...
          {/* Table */}
          <div className="mb-4">
            <p className="fw-bold mb-3">9. Deposit Diterima/ Wang Cagaran</p>
            ...
            <table className="table table-bordered" style={{ fontSize: '14px' }}>
              <thead>
                <tr className="table-light">
                  ...
                  <th>Deposit</th>
                  <th className="text-center" style={{ width: '120px' }}>Tarikh</th>
                ...
                {data.data.length === 0 ? (
                  ...
                  data.data.map((item, idx) => (
                    <tr key={item.id}>
                      ...
                      <td>{item.deposit}</td>
                      <td className="text-center">{formatDate(item.tarikh)}</td>
