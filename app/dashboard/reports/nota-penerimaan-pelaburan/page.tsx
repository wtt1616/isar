...
export default function NotaPenerimaanPelaburanReportPage() {
  ...
  return (
    <div className="container py-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2 no-print">
        <h4 className="mb-0">Laporan Nota Butiran Penerimaan Pelaburan</h4>
      ...
      {data && (
        <div ref={printRef} className="print-area">
          ...
          {/* Table */}
          <div className="mb-4">
            <p className="fw-bold mb-2">8. Pelaburan</p>
            <p className="ms-3 mb-3">a. Pelaburan Islamic Simpanan Tetap</p>
              ...
              <thead>
                <tr className="table-light">
                  ...
                  <th className="text-center" style={{ width: '140px' }}>
                    Tahun<br />Semasa<br />RM
                  </th>
                  <th className="text-center" style={{ width: '140px' }}>
                    Tahun<br />Sebelum<br />RM
                  </th>
                </tr>
              </thead>
              <tbody>
                {data.data.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="text-center text-muted">Tiada rekod</td>
                  </tr>
                ) : (
