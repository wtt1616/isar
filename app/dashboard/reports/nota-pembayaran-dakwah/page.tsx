...
export default function NotaPembayaranDakwahReportPage() {
  ...
  return (
    <div className="container py-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2 no-print">
        <h4 className="mb-0">Laporan Nota Butiran Pembayaran Dakwah dan Pengimarahan</h4>
      ...
      {data && (
        <div ref={printRef} className="print-area">
          ...
          {/* Main Table */}
          <p className="fw-bold mb-3">14. Dakwah Dan Pengimarahan (Sumbangan Am)</p>
